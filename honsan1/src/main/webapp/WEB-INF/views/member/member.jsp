...
<div class="body-container" style="width: 700px;">
    <div class="body-title">
        <h3><i class="fab fa-asymmetrik"></i> ${mode=="member"?"회원 가입":"회원 정보 수정"} </h3>
    </div>
			  ...
			  <table style="width: 100%; margin: 0px auto; border-spacing: 0px;">
			     <tr height="45"> 
			      <td align="center" >
			        ...
			        <button type="button" class="btn" onclick="javascript:location.href='${pageContext.request.contextPath}/';">가입취소</button>
			      </td>
			    </tr>
			    <tr height="30">
